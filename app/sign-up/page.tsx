...
export default function page() {
  ...
  return (
    <Flex pt='7rem' pb='2.5rem' px='8.4vw' mih='100%' justify='space-between' pos='fixed' top='0' left='0' right='0' bg='#fff' className="overlay">
      ...
      <Stack className='form'>
        ...
        <SignUpForm />
        <Text size='sm' ta='center'>Đã có tài khoản? <Link href='/sign-in'>Đăng nhập ngay</Link></Text>
      </Stack>
    </Flex>
  )
}
