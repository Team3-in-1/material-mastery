...
import { LoadingOverlay, Anchor, Breadcrumbs, Container, Group, Select, Divider } from '@mantine/core'
	...
	return (
		<Container fluid>
			...
			<Grid w='100%'>
				...
				<Grid.Col span={10}>
					<Group className='bg-white rounded-md' p={15} my={10} justify='space-between'>
						<Group>
