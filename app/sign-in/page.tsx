...
export default function page() {
  ...
  return (
    <Flex pt='7rem' pb='2.5rem' px='8.4vw' mih='100%' justify='space-between' align='self-start' pos='fixed' top='0' left='0' right='0' bg='#fff' className="overlay">
      <Group className='hidden-desktop' align='center' gap='1rem' px='0.5rem' py='1rem' pos='fixed' top='0' right='0' left='0'>
      ...
      <Stack className='form'>
        ...
        <SignInForm />
        <Text size='sm' ta='center'>Chưa có tài khoản? <Link href='/sign-up'>Đăng ký ngay</Link></Text>
      </Stack>
